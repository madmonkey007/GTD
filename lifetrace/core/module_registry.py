...
MODULES: tuple[ModuleDefinition, ...] = (
    ...
    ModuleDefinition(
        id="admin_safety", router_module="lifetrace.routers.admin_safety", core=True
    ),
    ...
    ModuleDefinition(
        ...
        dependencies=("chromadb", "hdbscan", "scipy"),
    ),
    ModuleDefinition(
        id="rag",
    ...
    ModuleDefinition(id="note_link", router_module="lifetrace.routers.note_link"),
    ModuleDefinition(id="collection", router_module="lifetrace.routers.collection"),
    ModuleDefinition(id="project", router_module="lifetrace.routers.project"),
    ModuleDefinition(id="habit", router_module="lifetrace.routers.habit"),
