...
settings = Dynaconf(
    ...
    validators=[
        ...
        Validator("journal_images_dir", default="uploads/journal-images/"),
        # 日志配置
        ...
        Validator("vector_db.siliconflow_api_key", default=""),
        Validator("vector_db.siliconflow_model", default="Qwen/Qwen3-VL-Embedding-8B"),
        # 聊天配置
