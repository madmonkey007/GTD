...
export function PriorityIcon({ className }: PriorityIconProps) {
	return (
		<svg
			...
			aria-hidden="true"
		>
			<path d="M294.5 877.4c-18.4 0-33.3-14.9-33.3-33.3V191.7c0-18.4 14.9-33.3 33.3-33.3s33.3 14.9 33.3 33.3v652.4c-0.1 18.4-15 33.3-33.3 33.3z" />
