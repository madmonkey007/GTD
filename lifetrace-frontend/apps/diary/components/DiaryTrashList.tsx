...
export function DiaryTrashList({
	...
	return (
		<button
			type="button"
			onClick={onShowTrash}
			className="flex w-full items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-muted-foreground/50 hover:bg-muted/20 hover:text-foreground/60 transition-colors"
		>
